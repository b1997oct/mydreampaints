...
const features = [
    {
        ...
        alt: "pd1",
        title: "900+ COLOURS",
        description: "Available in 900+ colours including all rainbow colours and shades.",
        imgClass: "w-16 h-16",
    },
    {
        src: pd2,
    ...
    },
    {
        ...
        alt: "pd3",
        title: "FINISH",
        description: "Formulated to provide beautiful, smooth finish that remains longer and safe to environment.",
        imgClass: "w-14 h-14",
    },
    {
        src: pd4,
        alt: "pd4",
        title: "AFFORDABLE",
        description: "An affordable yet long lasting paint for interior and exterior walls of your house.",
        imgClass: "w-16 h-16",
    },
]
    ...
    return (
        <div className='theme-container'>
            ...
            ${index === 2 ? "md:border-r-0 border-r-[1px] border-gray-400" : ""}`}
                    >
                        <Image src={item.src} alt={item.alt} className={item.imgClass} />
