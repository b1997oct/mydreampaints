...
export const itemsList = [
  {
    name: "Anurag house painting",
    description:
      "Here is what anurag says : We are realy happy and fully satified with the colour combination and customer service provided by my dream paints. We surely recommend my dream paints safe painting services to other",
    image: Paneer,
    rating: 4,
    bg:"bg-gradient-to-r from-sky-400 to-pink-200",
  },
  {
  ...
  {
    name: "Ganesh's House painting review",
    description:
  ...
  {
    name: "Here is What Madu Vidya Raj says",
    description:
  ...
  },
  {
    ...
    image: Gujrati,
    rating: 5,
    bg:"bg-gradient-to-r to-gray-600 from-gray-500",
  },
  {
    ...
    image: i1,
    rating: 4,
    bg:"bg-gradient-to-tl to-gray-400 from-red-500",
  },
  {
    ...
    image: i12,
    rating: 4,
    bg:"bg-gradient-to-t to-sky-500 from-orange-500",
  },
];
